 ...
 *
 * $Id: bvalidator.lang.ee.js 72 2011-08-01 16:15:28Z bmauser $
 */
...
var bValidatorOptions = {
	...
	errorMessages: {
		ee: {
			...
			'required':   'Noutud v‰li.',
			'alpha':      'Lubatud on ainult t‰hed.',
			'alphanum':   'Lunatud on ainult t‰hed ju numbrid.',
			'digit':      'Lubatud on ainult numbrid.',
			'number':     'Palun sisesta korrektne number.',
			'email':      'Palun sisesta korrektne email.',
			'image':      'Selles v‰ljas on lubatud ainult pildifailid',
